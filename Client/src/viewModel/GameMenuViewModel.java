...
>>>>>>> master
  ...
  public void addGame(String name, String type, String releaseYear,
      ...
      LocalDate availableTo, boolean needsDeposit) throws RemoteException
  {
    ...
    GregorianCalendar availableFromDateCalendar = GregorianCalendar
        .from(availableFrom.atStartOfDay(ZoneId.systemDefault()));
    GregorianCalendar availableToDateCalendar = GregorianCalendar
        .from(availableTo.atStartOfDay(ZoneId.systemDefault()));
    DateInterval availableDate = new DateInterval(availableFromDateCalendar,
        availableToDateCalendar);
