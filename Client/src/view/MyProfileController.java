...
public class MyProfileController {
    @FXML
    ListView<Game> incomingTradeList;    //this was "list". Changed it to this value everywhere for the sake of testing
    @FXML
    ListView<Game> owned;
    @FXML
    ListView<Game> pendingTradesList;
    @FXML
    ListView<Game> rented;
    @FXML
    Label bio;
    ...
    public void reset() throws RemoteException {
        this.incomingTradeList
                .setItems(myProfileViewModel.getIncomingTradeList()); //finish the method getList
        this.owned
                .setItems(myProfileViewModel.getOwnedGameList()); //finish the method getList
        this.rented
                .setItems(myProfileViewModel.getRentedGameList()); //finish the method getList
    ...
    public void onDeleteGame() throws RemoteException {
        if (owned.getSelectionModel().getSelectedIndex() < 0) {
            ...
            if (owned.getSelectionModel().getSelectedItem() == null) {
                this.myProfileViewModel.getOwnedGameList().remove(index); //ok java you kinky
            }
    ...
    @FXML
    public void onEditProfile() throws RemoteException {
