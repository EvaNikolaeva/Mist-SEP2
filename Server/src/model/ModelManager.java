...
public class ModelManager implements Model
{
  ...
  {
    gameList.addGame(game.getTitle(), game.getType(), game.getReleaseYear(),
        game.deposit(), game.getAvailabilityPeriod(), game.getUserId());
    propertyChangeSupport.firePropertyChange("gameAdded", game, game);
  }
